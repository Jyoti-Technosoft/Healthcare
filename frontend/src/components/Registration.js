          ...
          <div className="row border rounded-5 p-3 bg-white shadow box-area">
            <div className="col-md-6 right-box">
              <div className="row align-items-center">
                ...
                <div className="input-group mb-3">
                  <button className="btn btn-lg btn-light w-100 fs-6"><img alt='card-1' src="img/google.png" style={{ width: '20px' }} className="me-2" /><small>Sign Up with Google</small></button>
                </div>
            ...
            <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style={{ background: '#1977cc' }}>
              <div className="featured-image mb-3">
                <img alt='card-2' src="img/ability_img.png" className="img-fluid" style={{ width: '220px' }} />
              </div>
